...
interface ObjectFactoryCallback<T> {
    ...
    /**
     * 实例化并获取一个对象。
     * 当一个 {@link com.src_resources.libraries.objectFactory.ObjectFactory ObjectFactory} 的 {@link com.src_resources.libraries.objectFactory.ObjectFactory#obtainObject() obtainObject()} 被调用时，将回调此方法来实例化对象。
